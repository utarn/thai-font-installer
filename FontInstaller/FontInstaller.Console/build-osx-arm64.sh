...
# Build script for FontInstaller - macOS ARM64 (Apple Silicon)
# Builds self-contained executable for macOS arm64 (M1/M2/M3/M4)
...
echo -e "Note: This is a self-contained macOS (Apple Silicon) binary."
